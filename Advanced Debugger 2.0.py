...
class Debug:    #The debug class
    ...
    def Head(self, frame, end, cont = ""):
        if end:
            return str('Line '+ str(self.prevLine - self.FirstLine) + cont + ' (Programe Line ' + str(self.prevLine) + '):') #last line
        else:
            return str('Line '+ str(self.prevLine - self.FirstLine) + ' (Programe Line ' + str(self.prevLine) + '): ')
            self.startTime = time.time_ns()        
